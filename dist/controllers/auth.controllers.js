        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 5, , 6]);
                        return [4, user_model_1.User.findOne({ where: { email: email } })];
                    case 2:
                        user = _b.sent();
                        if (!user) {
                            return [2, res.status(401).json({ message: 'Email or password is incorrect.' })];
                        }
                    ...
                    case 3:
                        ...
                        return [4, user.getPhoto()];
                    case 4:
                        photo = _b.sent();
                        return [2, res.json({ token: token, photo: photo })];
                    case 5:
                        error_1 = _b.sent();
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        ...
                        if (existingUser) {
                            return [2, res.status(400).json({ message: 'User already exists.' })];
                        }
                    ...
                    case 4:
                        savedUser = _d.sent();
                        return [4, (0, email_1.sendActivationEmail)(savedUser.email)];
                    case 5:
                        _d.sent();
                        return [2, res.status(201).json({ message: 'User created successfully.' })];
                    case 6:
                        error_2 = _d.sent();
